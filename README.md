...
#1 JEST/test suite: worked on by dante - run the ListingService.test.js test file to run (run in your terminal by using this command: "npx jest /**tests**/ListingService.test.js")
